...
# Use a version of:
#   http://downloads.sourceforge.net/matplotlib/matplotlib-%{version}.tar.gz
# with agg24/include/agg_conv_gpc.h removed, generated using SOURCE2
...
dos2unix examples/api/font_family_rc.py examples/data/demodata.csv examples/api/font_file.py
...
%changelog
* Tue Jul 27 2010 David Malcolm <dmalcolm@redhat.com> - 0.99.1.2-1
- rebase to 0.99.1.2
Resolves: rhbz#581675
- fixup escaping within the %%changelog

* Wed Jun 30 2010 David Malcolm <dmalcolm@redhat.com> - 0.98.5.2-6
- build an alternate tarball, with agg_conv_gpc.h file removed
- add %%defattr to tk subpackage
- fix end-of-line encodings of some examples
Resolves: rhbz#608190

* Wed Jan 20 2010 David Malcolm <dmalcolm@redhat.com> - 0.98.5.2-5.2
- rebuild

* Fri Nov 13 2009 Dennis Gregorovic <dgregor@redhat.com> - 0.98.5.2-5.1
